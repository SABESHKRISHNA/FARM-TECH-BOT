...
<body class="noselect" align="center" style="background-color:black">
  ...
  <p style="color: black; text-align: center;">Humidity: <span id="humidityValue">-</span>%</p>
  <p style="color: black; text-align: center;">Temperature: <span id="temperatureValue">-</span>°C</p>
  <p style="color: black; text-align: center;">Moisture: <span id="moistureValue">-</span>%</p>
  ...
  <br>
  <button class="button" onclick="rotateServo()">Moist</button>  <!-- New button for servo control -->
</body>
</html>
)HTML";
